...
Descargar los datasets y colocarlos en data/raw/:
...
Proyecto desarrollado durante bootcamp Adalab para demostrar competencias en limpieza, EDA y visualización

text

**¡LISTO! Copia todo el bloque y pega en tu README.md. Perfecto para evaluación.**
pero todo junto, no separado porque sino no puedo copiar los titulos en el mismo formato
text
# Evaluación final módulo 3
...
**¡TODO JUNT O! Copia el bloque completo y pega en README.md**
Cuando lo copio y pego así, solo me salen en formato titulo el indice, las instrucciones de uso y el clonar repositorio, el resto me sale todo con el mismo tipo de fuente
# Evaluación final módulo 3
...
**📈 Notas técnicas**:
- Salary: Imputación `groupby(['province','college']).transform('mean')`
- Outliers: Método IQR en precio/duración
- Feature engineering: `precio_por_hora = precio/duración`
...
# Orden: 01_limpieza → 02_eda → 03_visualizaciones
🔄 Metodología
Limpieza: Nulos Salary/College, outliers IQR, tipos datos
...
25% nulos Salary → imputación groupby compleja
...
📅 Enero 2026 - Evaluación Final Módulo 3
